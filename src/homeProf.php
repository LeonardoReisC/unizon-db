...
<nav class="navbar navbar-inverse">
      ...
      <br>
      <?php
        //$teste = mysqli_query($conexao, "SELECT nome FROM alunos WHERE email = '$logado'");
        //echo "nome= $teste";
        echo "<h1>Bem vindo <u>$logado</u></h1>";
      ?>
      <div class="conteudo">
        <div class="imagens">
            <img class="imagem"src="aula.webp">
            <br>
            <a class="legenda">Oportunidades de Doutorado na UNIZON</a>
        </div>
        <div class="imagens">
            <img class="imagem"src="salaAula.jpg">
            <br>
            <a class="legenda">Novas diretrizes da UNIZON</a>
        </div>
      </div>
</body>
</html>